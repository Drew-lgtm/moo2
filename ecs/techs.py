...
TECHS: dict[str, dict] = {
    ...
    "class_i_shield": {
        ...
        "cost": 100, "prereqs": [],
        "description": "Basic ship shielding (+1 defense)",
        "equipment": {"slot": "shield", "size": 1, "defense": 1},
    },
    "personal_shield": {
    ...
    "class_iii_shield": {
        ...
        "description": "Stronger deflectors (+2 defense)",
        "equipment": {"slot": "shield", "size": 1, "defense": 2},
    },
    "tractor_beam": {
    ...
    "class_v_shield": {
        ...
        "description": "Heavy deflectors (+3 defense)",
        "equipment": {"slot": "shield", "size": 2, "defense": 3},
    },
    ...
    "class_vii_shield": {
        ...
        "description": "Capital shields (+4 defense)",
        "equipment": {"slot": "shield", "size": 2, "defense": 4},
    },
    "wide_area_jammer": {
    ...
    "hard_shields": {
        ...
        "description": "Block all small-arms fire (+5 defense)",
        "equipment": {"slot": "shield", "size": 3, "defense": 5},
    },
    "cloaking_field": {
