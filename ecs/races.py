...
TRAIT_ORDER = [
    ...
    "ship_attack", "ship_hull", "warlord", "hive_mind", "mind_link", "spymaster",
...
RACES: dict[str, dict] = {
    ...
    "Bulrathi":  {"name": "Bulrathi",  "traits": ["warlord", "ship_hull", "industry_bonus", "slow_growth"],
                  "description": "Massive ursinoids — devastating in ground combat, prodigious workers."},
    ...
    "Trilarian": {"name": "Trilarian", "traits": ["food_bonus", "ship_attack"],
                  "description": "Aquatic and well-armed."},
